...
import music from "./collection/transports/music/index.js";
import captcha from "spreadable-ms/src/approval/transports/captcha/index.js";
    ...
    return class NodeMuseria extends (Parent || NodeStoracle) {
        ...
        */
        ...
        async getSongInfoFilterOptions() {
            return {
                fnFilter: c => (utils.isValidSongAudioLink(c.audioLink) &&
